...
import { ShoppingBag, Heart, User, Menu, X, Search, Instagram } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-5 text-taupe">
          <button className="hover:text-rose-gold transition-colors duration-300">
          ...
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hidden sm:block hover:text-rose-gold transition-colors duration-300">
          ...
          >
            <div className="flex flex-col p-8 space-y-6">
              ...
              <div className="pt-6 border-t border-warm-gray flex space-x-6">
                <a href="#" className="text-taupe hover:text-rose-gold"><Instagram size={20} /></a>
